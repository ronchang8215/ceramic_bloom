...
<div>
  <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <div class="jumbotron introduce1 row">
      <div class="col-md-4"><h2 class="display-4">關於陶瓷</h2></div>
      <div class="col-md-8">
    ...
    <div class="jumbotron introduce2">
      <h2 class="display-4 p-3 mx-3">如何製作好的陶瓷？</h2>
    ...
    <div class="display-3 mb-3"><span>來這選出你的陶瓷</span></div>
    <div class="jumbotron buyit">
      <h3 class="mb-3">茶具、碗具、小物<hr>每一樣商品皆經過專業工法及匠人的用心，任君挑選</h3>
      <router-link class="btn button__shop p-5" role="button" to="/customproduct">
      查看商品</router-link>
    </div>
  </div>
</div>
...
.buyit {
  background-image: url(../../assets/img/tom-crew-bgIO-u4GEfI-unsplash.jpg);
  background-size: cover;
  background-position: center;
