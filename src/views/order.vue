...
<div>
  <loading :active.sync="isLoading"></loading>
    ...
    <Pagination :pages="pagination" @getPage="getOrder"></Pagination>
</div>
</template>
...
export default {
  ...
  methods: {
    getOrder(page = 1) {
      ...
      console.log(vm);
      vm.isLoading = true;
      this.$http.get(`${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/orders?page=${page}`).then((res) => {
